...
## Введение: обзор курса, макроэкономическая статистика, работа с базами данных
```
...
1.2. Review of macroeconomic statistics frameworks:
    ...
    ПРИОРИТЕТЫ: (1.2.а), (1.2.b) - обязательно в анчале курса, 
...
- Rouble vs oil:
   ...
   КОММЕНТАРИИ:
        ...
        Рассматривается как дополнительная лекция в конце завершающей стадии курса. Для нее желательно раздать 
        используемые данные заранее и дать простые задания по работе с ними/для ознакомления с материалом лекции через
        выполнение заданий. Таким образом проще будет устанвоиьт связь между презентацией и практическими работами. 
